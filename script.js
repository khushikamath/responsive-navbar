const stopwatchDuaration = document.getElementById("stopwatchDuaration");
...
start.onclick = () => {
    timeInterval = setInterval(() => {
        ...
        stopwatchDuaration.innerHTML = `${zeroPad(hrs)}:${zeroPad(mins)}:${zeroPad(sec)}:${zeroPad(ms)}`;
...
reset.onclick = () => {
    ...
    clearInterval(timeInterval);
    stopwatchDuaration.innerHTML = "00:00:00:00";
    start.innerHTML = "Start";
    lap.setAttribute("style", "display:block");
    lap.setAttribute("dislabed", true);
    reset.setAttribute("style", "display:none");
    start.setAttribute("style", "display:block");
    stop.setAttribute("style", "display:none");
